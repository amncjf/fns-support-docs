...
Twitter does not yet integrate FNS names, or verify them, so setting them as your Twitter name is simpler than it first appears.
...
Type in your FNS name in the `Name` field
...
That's it! You're done and should now be sporting your FNS name on Twitter!
