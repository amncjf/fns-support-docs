...
# How to Set a Record
Connect to the <Link to="https://app.fildomains.com"><b>FNS Manager App</b></Link> with the wallet set as `Controller` for the FNS name you want to set a record for and click `Add/Edit Record`
